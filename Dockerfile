...
RUN apt install git g++ cmake pkg-config libgstreamer1.0-dev libgstreamer-plugins-base1.0-dev libglib2.0-dev libgirepository1.0-dev libzip-dev libzip4 libglib2.0-0 libgirepository-1.0-1 libusb-1.0-0-dev libusb-1.0-0 uuid-dev libuuid1 libudev-dev libudev1 python3-sphinx libc6 libgstreamer1.0-0 gstreamer1.0-plugins-base gstreamer1.0-plugins-good gstreamer1.0-plugins-bad gstreamer1.0-plugins-ugly qtgstreamer-plugins-qt5 libxml2-dev libxml2 ninja-build libqt5widgets5 libqt5gui5 qtbase5-dev graphviz -y
...
run apt install build-essential checkinstall zlib1g-dev libssl-dev fish htop -y
...
run cd /tmp/cmake-3.21.0;./bootstrap
